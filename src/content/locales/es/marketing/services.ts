...
export const services: LocaleServices = {
  ...
  sovereign: {
    ...
    services: [
      ...
      },
      {
        ...
        computeBullets: [
          [{ type: "bold", content: "Pago por ejecución" }, { type: "text", content: " — solo pagas lo que usas" }],
          [{ type: "bold", content: "Autoescalado" }, { type: "text", content: " — de 1 a 1.000.000 de peticiones" }],
          [{ type: "bold", content: "Edge computing global" }, { type: "text", content: " — corre cerca de tus usuarios" }],
          [{ type: "bold", content: "Gana compartiendo" }, { type: "text", content: " — contribuye con computación y gana tokens" }],
        ],
      },
    ],
  },
  ...
  blockchainCta: {
    ...
    paragraphs: [
      [
        { type: "text", content: "En el corazón de todo está " },
        { type: "bold", content: "Infinite Improbability Drive" },
        { type: "text", content: " — nuestra blockchain que hace lo imposible, improbable." },
      ],
      [
        { type: "text", content: "Llamada así por el motor revolucionario de Douglas Adams, impulsa la gobernanza con tokens " },
        { type: "bold", content: "[42]" },
        { type: "text", content: " y recompensa a los contribuidores de la red con tokens " },
        { type: "bold", content: "Fish" },
        { type: "text", content: "." },
      ],
    ],
    bullets: [
      [{ type: "bold", content: "[42]" }, { type: "text", content: " — Token de gobernanza y utilidad para staking y votación" }],
      [{ type: "bold", content: "Fish" }, { type: "text", content: " — Se gana contribuyendo almacenamiento, cómputo y ancho de banda" }],
      [{ type: "bold", content: "Gobernanza DAO" }, { type: "text", content: " — decisiones on-chain por la comunidad" }],
      [{ type: "bold", content: "Proof of Contribution" }, { type: "text", content: " — recompensa a quienes construyen y mantienen" }],
      [{ type: "bold", content: "Desvíos del hiperespacio" }, { type: "text", content: " — puentes nativos a Bitcoin, Ethereum, Cosmos y más" }],
    ],
